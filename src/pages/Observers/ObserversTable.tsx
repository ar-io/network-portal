...
const ObserversTable = () => {
  ...
  return (
    <div>
      <div className="flex w-full flex-wrap items-center justify-between gap-y-2 rounded-t-xl border border-grey-600 bg-containerL3 py-2 pl-6 pr-[0.8125rem] text-sm">
